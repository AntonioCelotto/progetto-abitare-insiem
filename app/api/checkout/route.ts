...
const products:any={pro_monthly:{name:'Portale PRO mensile',priceEnv:'STRIPE_PRICE_PRO_MONTHLY',mode:'subscription'},pro_yearly:{name:'Portale PRO annuale',priceEnv:'STRIPE_PRICE_PRO_YEARLY',mode:'subscription'},assisted_monthly:{name:'Portale Assistito',priceEnv:'STRIPE_PRICE_ASSISTED_MONTHLY',mode:'subscription'},strategy:{name:'Sessione strategica',priceEnv:'STRIPE_PRICE_STRATEGY',mode:'payment'},light:{name:'Consulenza LIGHT',priceEnv:'STRIPE_PRICE_LIGHT',mode:'payment'},full:{name:'Consulenza FULL',priceEnv:'STRIPE_PRICE_FULL',mode:'payment'},'360':{name:'Abitare Insieme 360',quote:true}};
